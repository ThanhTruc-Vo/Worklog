...
1. **Object Ownership**: Chọn **ACLs disabled**.
2. **Block Public Access settings for this bucket**: **Bỏ tích** ở ô **Block all public access**. 
![Unblock Public Access](/images/5-Workshop/5.3-Storage-Database/s3-frontend-public-2.png)

1. Tích vào ô xác nhận cảnh báo màu vàng để đồng ý rằng bucket này có thể truy cập công khai.
![Unblock Public Access](/images/5-Workshop/5.3-Storage-Database/s3-frontend-public-3.png)

1. Các tuỳ chọn còn lại giữ nguyên không thay đổi. Bấm **Create bucket**.