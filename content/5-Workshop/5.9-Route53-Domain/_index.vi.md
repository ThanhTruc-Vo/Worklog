...
1. Nhấn nút **Create hosted zone**.
2. Sau khi tạo thành công, Route 53 sẽ cấp phát cho bạn 4 địa chỉ máy chủ phân giải tên miền (Name Servers - bản ghi loại `NS`).
![Custom Domain](/images/5-Workshop/5.9-Route53-Domain/custom-r53-2.png)
1. Đăng nhập vào trang quản trị của nhà cung cấp tên miền của bạn (ví dụ: P.A Việt Nam, MatBao, v.v.).
2. Tìm đến phần **Thay đổi DNS** (hoặc Name Servers), xóa các bản ghi cũ và cập nhật 4 địa chỉ NS này vào để ủy quyền quản lý tên miền cho AWS.
